...
<body>
    ...
    <table class="table1">
    <tr>
        <td colspan="2">REPORTE STATUS DE EQUIPO DE COMPUTO</td>
    </tr>
    <tr>
    ...
    <tr>
        <td class="td1">MOTIVO DE BAJA</td>
        <td class="det">{{$equipo['motivo']}}</td>
    </tr>
    <tr>
        <td class="td1 det">COMO SE DETECTO EL EQUIPO</td>
        <td class="det">{{$equipo['detecto']}}</td>
    </tr>
    <tr>
